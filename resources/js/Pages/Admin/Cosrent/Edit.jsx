...
export default function Edit({ cosrent, user }) {
    const { flash = {} } = usePage().props;

    const { data, setData, put, processing, errors, reset } = useForm({
        cosrent_name: cosrent.cosrent_name || "",
        email: user.email || "",
        telp_number: cosrent.telp_number || "",
        address: cosrent.address || "",
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(route("admin.cosrent.update", cosrent.id));
    };
